...
//    val run1 = PriorityRunnable(Priority.UI_LOW, Runnable {
//        Thread.sleep(300)
//        println("第一个任务")
//    })
//
//    val run2 = PriorityRunnable(Priority.UI_NORMAL, Runnable {
//        println("第二个任务")
//    })
//
//    val run3 = PriorityRunnable(Priority.UI_TOP, Runnable {
//        Thread.sleep(200)
//        println("第三个任务")
//    })
